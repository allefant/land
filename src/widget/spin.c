...
extern LandWidgetInterface *land_widget_spin_interface;

#define LAND_WIDGET_SPIN(widget) ((LandWidgetSpin *) \
    land_widget_check(widget, LAND_WIDGET_ID_SPIN, __FILE__, __LINE__))

#define LAND_WIDGET_SPINBUTTON(widget) ((LandWidgetSpinButton *) \
...
LandWidget *land_widget_spinbutton_new(LandWidget *parent, LandImage *image,
...
void land_widget_spin_initialize(LandWidget *base,
...
LandWidget *land_widget_spin_new(LandWidget *parent,
