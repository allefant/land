...
#define LAND_WIDGET_HBOX(widget) ((LandWidgetHBox *) \
    land_widget_check(widget, LAND_WIDGET_ID_HBOX, __FILE__, __LINE__))
...
void land_widget_hbox_initialize(LandWidget *base, LandWidget *parent,
