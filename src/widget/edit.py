...
extern LandWidgetInterface *land_widget_edit_interface;

#define LAND_WIDGET_EDIT(widget) ((LandWidgetEdit *) \
    land_widget_check(widget, LAND_WIDGET_ID_EDIT, __FILE__, __LINE__))
...
void land_widget_edit_initialize(LandWidget *base,
...
LandWidget *land_widget_edit_new(LandWidget *parent, char const *text,
    void (*modified)(LandWidget *self), int x, int y, int w, int h)
{
    LandWidgetEdit *edit;
    land_alloc(edit);
